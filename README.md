...
**Jira:** `jira_create_issue` · `jira_get_issue` · `jira_update_issue` · `jira_list_issues` · `jira_add_comment` · `jira_find_users` · `jira_add_worklog` · `jira_update_worklog` · `jira_list_worklogs` · `jira_set_story_points` · `jira_list_sprints` · `jira_move_to_sprint`  
